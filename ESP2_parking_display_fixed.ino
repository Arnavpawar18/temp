...
// Server IP
const char* serverIP = "10.109.142.101";

// Pin definitions for ESP32
#define SLOT1_IR_PIN    32
#define SLOT2_IR_PIN    33
#define SLOT3_IR_PIN    25
#define SLOT4_IR_PIN    26
...
void setup() {
  ...
  Serial.println("ESP32 Ready at: http://" + WiFi.localIP().toString());
}

void loop() {
  server.handleClient();
  
  // Debug: Print sensor values every 5 seconds
